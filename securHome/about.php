    ...
    <div class="container py-lg-5 py-sm-4">
        <div class="maghny-gd-1">
            <div class="row about-text">
                <div class="col-lg-6">
                    <h3 class="title-big">EVERY HOME WILL BECOME A SMART HOME</h3>
                </div>
                <div class="col-lg-6">
                    <p>SecureHome is among the top brand list to provide smart home
                       products and solutions on the global market. We offer complete
                        categories of smart devices, integrating advanced IoT technologies 
                        and cloud services, to form the base of both smart home solutions and other industrial solutions.
                    </p>
                </div>
            </div>
            <div class="row mt-5">
                    ...
                    <div class="maghny-grid">
                        <figure class="effect-lily border-radius">
                            ...
                            <figcaption class="w3set-hny">
                                <div>
                                    <h4>SecureHome User  <span> Interface </span></h4>
                                    <p>Simple and Easy</p>
                                </div>
                ...
                <div class="maghny-gd-1 col-lg-4 col-md-6 mt-md-0 mt-4">
                    <div class="maghny-grid">
                        <figure class="effect-lily border-radius">
                            ...
                            <figcaption class="w3set-hny">
                                <div>
                                    <h4>All Smart Devices  <span> Integration</span></h4>
                                    <p  >Ease of insertion </p>
                                </div>
                ...
                <div class="maghny-gd-1 col-lg-4 col-md-6 mt-lg-0 mt-4">
                    <div class="maghny-grid">
                        <figure class="effect-lily border-radius">
                            ...
                            <figcaption class="w3set-hny">
                                <div>
                                    <h4>Possibility of use on  <span> all devices</span></h4>
                                    <p>All Devices </p>
                                </div>
        ...
        <div class="container py-lg-4 py-md-3">
            ...
            <div class="row w3-services-grids">
                <div class="col-lg-9 w3-services-right-grid pl-lg-5 mx-auto">
                    <h4 class="mb-md-5 mb-4">Our general features</h4>
                    <div class="fea-gd-vv row">
                        <div class="col-md-6">
                            <div class="float-lt feature-gd">
                                <div class="icon"> <span class="fa fa-file-text-o" aria-hidden="true"></span></div>
                                <div class="icon-info">
                                    <h5>We do the right thing</h5>
                                    <p> We conduct business with integrity and do what is right
                                       for our employees, customers, shareholders, communities and planet. </p>
                        ...
                        <div class="col-md-6 mt-md-0 mt-4">
                            <div class="float-mid feature-gd">
                                ...
                                <div class="icon-info">
                                    ...
                                    <p> The best automation system of the year award by GOOGLE between 2022 and 2023. </p>
                                </div>
                            </div>
                        </div>
...
<section class="team py-5" id="team">
	<div class="container py-lg-4 py-sm-3">
        <h3 class="title-big text-center mb-md-5 mb-4">Founders</h3>
