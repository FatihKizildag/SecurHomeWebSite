  ...
  <body>
                ...
                <div class="banner-info">
                  <div class="container">
                    <div class="banner-info-bg">
                      <h5>
                      Home is where the heart is, Efficiency and security starts from the heart.
                      </h5>
                      <a
              ...
              <div class="slider-info banner-view banner-top1 bg bg2">
                <div class="banner-info">
                  <div class="container">
                    <div class="banner-info-bg">
                      <h5>
                      Remote control, peace of mind at your fingertips, 
              ...
              <div class="slider-info banner-view banner-top2 bg bg2">
                <div class="banner-info">
                  <div class="container">
                    <div class="banner-info-bg">
                      <h5>
                      Managing your air conditioner remotely keeps comfort under your control.
                      </h5>
                      <a
                        class="btn btn-style transparent-btn mt-sm-5 mt-4"
                        href="about.php"
              ...
              <div class="slider-info banner-view banner-top3 bg bg2">
                <div class="banner-info">
                  <div class="container">
                    <div class="banner-info-bg">
                      <h5>
                      With remote surveillance, you can keep an eye 
                        on what matters most, from anywhere, anytime.
                      </h5>
                      <a
                        class="btn btn-style transparent-btn mt-sm-5 mt-4"
                        href="about.php"
    ...
    <div class="best-rooms py-5">
      <div class="container py-lg-5 py-sm-4">
        <h3 class="title-big text-center">Our Products</h3>
